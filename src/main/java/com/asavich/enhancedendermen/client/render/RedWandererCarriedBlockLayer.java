...
public class RedWandererCarriedBlockLayer extends RenderLayer<RedWanderer, RedWandererModel<RedWanderer>> {

    private final BlockRenderDispatcher blockRenderer;

    public RedWandererCarriedBlockLayer(RenderLayerParent<RedWanderer, RedWandererModel<RedWanderer>> p_234814_, BlockRenderDispatcher p_234815_) {
        super(p_234814_);
        this.blockRenderer = p_234815_;
    }

    public void render(PoseStack p_116639_, MultiBufferSource p_116640_, int p_116641_, RedWanderer p_116642_, float p_116643_, float p_116644_, float p_116645_, float p_116646_, float p_116647_, float p_116648_) {
