package com.asavich.enhancedendermen.client.model;
...
public class RedWandererModel <T extends LivingEntity> extends HumanoidModel<T>{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(EnhancedEndermen.MOD_ID, "red_wanderer"), "main");
    public boolean carrying;
    public boolean creepy;

    public RedWandererModel(ModelPart root) {
        super(root);
    }
